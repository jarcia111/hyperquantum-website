...
export default function Navbar() {
  ...
  return (
    <header className={cn(
      ...
      {/* Estructura de dos columnas al mismo nivel */}
      <div className="flex">
        {/* Columna izquierda con logo en fondo blanco */}
        ...
        {/* Columna derecha con menú en fondo claro */}
        <div className="flex-1 bg-[#F5F7FA]">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-full py-3 sm:py-4">
              <div className="hidden sm:block">
                <span className="text-lg sm:text-xl font-bold font-poppins tracking-wider text-primary">HYPERQUANTUM</span>
              </div>
